                    ...
                    <div class="main-tabel">
                        <div class="isi-main">
                            <div class="main-input">
                                ...
                                <input type="text" placeholder="Matematika" name="nama" required value="{{ $ekskul->nama }}">
                            </div>
                            <div class="main-input">
                                <p>Pembina</p>
                                <select name="guru_id" id="walikelas" required>
                                    ...
                                    @foreach ($teachers as $teacher)
                                        <option {{ ($ekskul->guru_id == $teacher->id) ? 'selected' : '' }} value="{{ $teacher->id }}">{{ $teacher->user->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="main-input">
                                ...
                                <select name="tahun_ajaran_id" id="ajaran">
                                    ...
                                    @foreach ($tahunAjarans as $tahunAjaran)
                                        <option {{ ($ekskul->tahun_ajaran_id == $tahunAjaran->id) ? 'selected' : '' }} value="{{ $tahunAjaran->id }}">{{ $tahunAjaran->tahun }} - {{ $tahunAjaran->semester }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="submit">
                            <button><a href="{{ route('ekskul.index') }}">Kembali</a></button>
