...
<body>
    <div class="container">
        ...
        <main>
            <div class="main-head">
                <p class="main-title">Edit Data Prestasi</p>
                <div class="time">
                    <p>
                            ...
                            <div class="main-input">
                                ...
                                <select name="tahun_ajaran_id" id="ajaran" required>
                                    ...
                                    @foreach ($tahunAjarans as $tahunAjaran)
                                        <option {{ ($prestasi->rapor->tahun_ajaran_id == $tahunAjaran->id) ? 'selected' : '' }} value="{{ $tahunAjaran->id }}">{{ $tahunAjaran->tahun }} - {{ $tahunAjaran->semester }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
