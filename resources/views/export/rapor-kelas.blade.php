        ...
        <main class="mx-auto w-[1080px] font-tinos"
            ...
            <div class="mx-auto w-fit text-xs">
                                ...
                                @foreach ($siswa->rapor->where('tahun_ajaran_id', $kelas->tahunAjaran->id)->first()->mapelRapor as $i => $mapelRapor)
                                    @if ($mapelRapor->mapel->kelompok == 'Muatan Nasional')
                                        <tr>
                                            ...
                                            <td class="text-center">{{ $mapelRapor->nilaiPengetahuanC3->predikat }}
                                            </td>
                                            ...
                                            <td class="text-center">{{ $mapelRapor->nilaiKeterampilanC4->predikat }}
                                            </td>
                            ...
                            <tbody>
                                @php
                                    $totalNilaiC3 = $siswa->rapor
                                        ->where('tahun_ajaran_id', $kelas->tahunAjaran->id)
                                        ->first()
                                        ->mapelRapor()
                                        ->join(
                ...
                <section class="mt-8 flex justify-around text-center">
                    ...
                    <div class="flex flex-col gap-20">
                        <span>
                            <h4>{{ $kelas->tahunAjaran->tempat_pembagian }},
                                {{ date('d F Y', strtotime($kelas->tahunAjaran->tanggal_pembagian)) }}</h4>
                            <p>Orang Tua/Wali</p>
                        </span>
