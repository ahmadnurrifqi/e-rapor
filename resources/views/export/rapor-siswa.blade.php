...
<body>
    <main class="mx-auto w-[1080px] font-tinos"
        style="margin-top: 50px; position: relative; align-items: center;">
        <div
            style="position: absolute; z-index: 999; opacity: 20%; width: 100%; display: flex; height: 100%; justify-content: center;">
            <img style="width: 600px; object-fit: contain;" src="{{ public_path('./assets/kop_logo.png') }}" alt="KOP Sekolah">
        </div>
        <div class="mx-auto w-fit text-xs">
            ...
            <ol class="alpha max-w-[950px] space-y-2">
                ...
                <li class="!mt-4">
                    ...
                    <table class="ekskul w-full text-center">
                        ...
                        <tbody>
                            @php
                                $totalNilaiC3 = $siswa->rapor
                                    ->where('tahun_ajaran_id', $siswa->kelas->tahunAjaran->id)
                                    ->first()
                                    ->mapelRapor()
                                    ->join(
                                        'nilai_pengetahuan_c3_s',
                                        'mapel_rapors.nilai_pengetahuan_c3_s_id',
                                        'nilai_pengetahuan_c3_s.id',
                                    )
                                    ->sum('nilai_pengetahuan_c3_s.nilai');
                                $totalNilaiC4 = $siswa->rapor
                                    ->where('tahun_ajaran_id', $siswa->kelas->tahunAjaran->id)
                                    ->first()
                                    ->mapelRapor()
                                    ->join(
                                        'nilai_keterampilan_c4_s',
                                        'mapel_rapors.nilai_keterampilan_c4_s_id',
                                        'nilai_keterampilan_c4_s.id',
                                    )
                            ...
                            <tr>
                                ...
                                <td rowspan="2">
                                    {{ $siswa->rapor->where('tahun_ajaran_id', $siswa->kelas->tahunAjaran->id)->first()->peringkat }}
                                </td>
                ...
                <li class="!mt-4">
                    ...
                    <p class="w-full border border-black p-3 text-center font-bold italic">
            ...
            <section class="mt-8 flex justify-around text-center">
                ...
                <div class="flex flex-col gap-20">
                    <span>
                        <h4>{{ $siswa->kelas->tahunAjaran->tempat_pembagian }},
                            {{ date('d F Y', strtotime($siswa->kelas->tahunAjaran->tanggal_pembagian)) }}</h4>
                        <p>Orang Tua/Wali</p>
                    </span>
